 ...
 */
export declare const allPropNameList: ("b" | "p" | "style" | "sx" | "flex" | "alignItems" | "alignContent" | "justifyContent" | "flexWrap" | "flexDirection" | "flexGrow" | "flexShrink" | "flexBasis" | "alignSelf" | "position" | "pos" | "borderWidth" | "borderRadius" | "radius" | "m" | "mt" | "mr" | "mb" | "ml" | "mx" | "my" | "pt" | "pr" | "pb" | "pl" | "px" | "py" | "t" | "r" | "l" | "gapX" | "gapY" | "width" | "w" | "minWidth" | "minW" | "maxWidth" | "maxW" | "height" | "h" | "minHeight" | "minH" | "maxHeight" | "maxH" | "backgroundColor" | "bg" | "borderColor")[];
