...
): theme is Record<'semanticTokens', Record<string, unknown>> => isObject(theme.semanticTokens);
 ...
 */
function flattenSemanticTokens<Value = any>(target: Record<string, Value> | undefined | null) {
